export enum ProblemType {
  ...
  비트필드를_이용한_다이나믹_프로그래밍 = '비트필드를 이용한 다이나믹 프로그래밍',
  확률론 = '확률론',
  ...
  고속_푸리에_변환 = '고속 푸리에 변환',
  작은_집합에서_큰_집합으로_합치는_테크닉 = '작은 집합에서 큰 집합으로 합치는 테크닉',
  트라이 = '트라이',
  덱 = '덱',
  ...
  중간에서_만나기 = '중간에서 만나기',
  비트_집합 = '비트 집합',
  가장_긴_증가하는_부분_수열_o_n_log_n = '가장 긴 증가하는 부분 수열: o(n log n)',
  피타고라스_정리 = '피타고라스 정리',
  순열_사이클_분할 = '순열 사이클 분할',
  kmp = 'kmp',
  가우스_소거법 = '가우스 소거법',
  ...
  매내처 = '매내처',
  폴라드_로 = '폴라드 로',
  커넥션_프로파일을_이용한_다이나믹_프로그래밍 = '커넥션 프로파일을 이용한 다이나믹 프로그래밍',
